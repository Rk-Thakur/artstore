<?php
                  ...
                  $result=mysqli_query($conn,$sql);
                        ...
                        $update="UPDATE homepage set file='$image' ,topic1='$topic1',topic2='$topic2',description='$description' where id='$id' ";
                        $result=mysqli_query($conn,$update);
                        if($result){
                        header("Location: dashboard.php");//redirect to view.php after successfully updated record
                        }
                        else{
...
<body>
  ...
  <h1 class=" w-full text-center text-grey-darkest mb-6"> Edit Homepage</h1>
    ...
    <form class="" name="form" action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex flex-col mb-4 md:w-full">
        ...
        <input class="border py-2 px-3 text-grey-darkest md:ml-2" type="text" name="topic1" value="<?php echo $row['topic1'];?>">
      </div>
      <div class="flex flex-col mb-4 md:w-full">
        <label class="mb-2 uppercase font-bold text-lg text-grey-darkest md:ml-2" >Second Line</label>
        <input class="border py-2 px-3 text-grey-darkest md:ml-2" type="text" name="topic2" value="<?php echo $row['topic2'];?>">
      </div>
