...
$sql="INSERT into about(file,topic,description) values('$file','$topic','$description')";
...
<body>
  ...
  <div class="w-full bg-white rounded  p-8 m-4 md:max-w-sm md:mx-auto">
    <h1 class=" w-full text-center text-2xl font-bold text-grey-darkest mb-6">About 📰</h1>
    ...
    <form class="" action="<?php echo $_SERVER['PHP_SELF']?>" method="POST" enctype="multipart/form-data">
      ...
      <button class="block   text-white bg-gray-900   uppercase  mx-auto p-4 rounded" type="submit" name="about">
      Upload About
      </button>
