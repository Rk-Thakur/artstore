...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
                ...
                <div class="w-full  p-3">
                    ...
                    <div class="bg-white border rounded shadow">
                        <div class="border-b p-3">
                            <h5 class="font-bold uppercase text-gray-600">Featured Art  <a href="insertart.php">       <i class="fas fa-images"></i></a></h5>
                        </div>
				...
				<table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
					<thead>
						<tr>
							...
							<th data-priority="3">Image Name</th>
							<!-- <th data-priority="4">Price</th> -->
							<th data-priority="5">Art Type</th>
							<th data-priority="6">Pieces?</th>
    ...
    ?>
						...
						<tr>
                            ...
                            <td> <?php echo '<img src="uploads/'. $row["file"].'" alt="blog" class="object-full object-center h-45 w-45">'; ?></td>
                            ...
                            <td ><a href="editart.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-edit"></i></a></td>

                            <td ><a href="deleteart.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-trash"></i></a></td>
                        </tr>
