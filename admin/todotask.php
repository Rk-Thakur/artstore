...
<?php
  ...
  $sql="INSERT into todo(message) values('$list')";
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
	...
	<div class="bg-white rounded shadow p-6 m-4 w-full lg:w-3/4 lg:max-w-lg">
        <div class="mb-4">
            ...
            <div class="flex mt-4 ">
                <input  type="text" name="message" required class="shadow appearance-none border rounded w-full py-2 px-3 mr-4 text-grey-darker" placeholder="Add Todo">
                <input type="submit" name="todo" value="Task" class="flex-no-shrink p-2 border-2 rounded text-green-500 border-green-300 hover:text-white hover:bg-green-400">
            </div>
            </form> 
        </div>
        <div>
				...
				<table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
					<thead>
						<tr>
							...
							<th data-priority="2">TO DO Task</th>
                ...
                while($row=mysqli_fetch_assoc($result)){
                    ...
                    ?>
						<tr>
                            ...
                            <td  ><a href="deletetask.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-trash"></i></a></td>
