                ...
                <div class="w-full ">
                    ...
                    <div class="bg-white border rounded shadow">
                        <div class="border-b p-3">
                            <h5 class="font-bold uppercase text-gray-600">Testimonial  <a href="inserttestimonial.php"> +++</a> </h5>
                        </div>
				...
				<table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                  ...
                  while($row=mysqli_fetch_assoc($result)){?>
						<tr>
                            ...
                            <td ><a href="deletetestimonial.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-trash"></i></a></td>
