            ...
            <div class="w-full  flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white z-20" id="nav-content">
                <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                    <li class="mr-6 my-2 md:my-0">
                        <a href="dashboard.php" class="block py-1 md:py-3 pl-1 align-middle text-pink-500 no-underline hover:text-gray-900 border-b-2 border-orange-600 hover:border-orange-600">
                            <i class=" text-pink-500 fas fa-home fa-fw mr-3 "></i><span class="pb-1 md:pb-0 text-sm">Home</span>
                        </a>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
    ...
    <div class="container w-full mx-auto pt-20">
        ...
        <div class="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
            ...
            <a href="dashboard.php">
                <input type="submit" name="Homepage" value="HomePage" class="flex-no-shrink p-2 border-2 rounded text-white-500 border-red-300 hover:text-white hover:bg-red-400">
            </a>
            <a href="about.php">
                <input type="submit" name="About" value="About" class="flex-no-shrink p-2 border-2 rounded text-white-500 border-red-300 hover:text-white hover:bg-red-400">
            </a>
                ...
                <div class="w-full p-3">
                    ...
                    <div class="bg-white border rounded shadow">
                        <div class="border-b p-3">
                            <h5 class="font-bold uppercase text-gray-600">HOMEPAGE <a href="inserthomepage.php">++++</a></h5>
                        </div>
				...
				<table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
					<thead>
						<tr>
							...
							<th data-priority="3">First Line</th>
							<th data-priority="4">Second Line</th>
					...
					<tbody>
                        <?php
                        include('config.php');
                        $query="SELECT * FROM homepage ORDER BY id desc ";
						...
						<tr>
							...
							<td><?php echo $row['topic2']; ?></td>
							<td><?php echo $row['description']; ?></td>
							<td ><a href="edithomepage.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-edit"></i></a></td>

                            <td ><a href="deletehomepage.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-trash"></i></a></td>
