...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
            ...
            <div class="flex flex-wrap">
                <div class="w-full md:w-1/2 xl:w-1/3 p-3">
                    ...
                    while($row=mysqli_fetch_assoc($result)){?>
                                <h3 class="font-bold text-3xl">Rs.<?php echo $row['total']; ?>  <span class="text-green-500"><i class="fas fa-caret-up"></i></span></h3>
                                <?php
                    }
                  }
                  ?>
                ...
                <div class="w-full p-3">
                    ...
                    <div class="bg-white border rounded shadow">
                        <div class="border-b p-3">
                            <h5 class="font-bold uppercase text-gray-600">About <a href="insertabout.php">++++</a></h5>
                        </div>
				...
				<table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
					<thead>
						<tr>
							...
							<th data-priority="3">Store Name</th>
    ...
    ?>
						...
						<tr>
							...
							<td ><a href="editabout.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-edit"></i></a></td>

                            <td ><a href="deleteabout.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-trash"></i></a></td>
